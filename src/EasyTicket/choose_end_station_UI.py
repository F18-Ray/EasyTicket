...
class choose_end_station:
    def __init__(self, computer_info_width, computer_info_height):
        ...
        self.windows_choose_end_station = tkinter.Toplevel()
        # self.windows_choose_end_station_icon = self.windows_choose_end_station.iconbitmap(
        #     r"./ticket_12306_prog_addition/download_photo.ico")
        self.end_station_entery = tkinter.Entry(
            self.windows_choose_end_station, background="#FFFFFF", foreground="#4B0082",
        ...
        self.screen_choose_end_station_x = int((computer_info_width - self.windows_choose_end_station_width) / 2)
        self.screen_choose_end_station_y = int((computer_info_height - self.windows_choose_end_station_height) / 2)
        self.windows_choose_end_station_position_str = "{}x{}+{}+{}".format(
            self.windows_choose_end_station_width, self.windows_choose_end_station_height,
    ...
    def button_research_get_info(self):
        ...
        self.button_get_end_station.pack(side=tkinter.TOP)
